...
import { mockCurrentUser, getSchedulesByStudent, Schedule, getUsers } from "@/lib/staticData"
  ...
  useEffect(() => {
    const loadSchedule = async () => {
      ...
      if (currentUser.role === 'student') {
        const studentSchedule = getSchedulesByStudent(currentUser.id)
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-2">Your weekly class timetable</p>
      </div>
